...
| # | Decisión | Estado |
|---|----------|--------|
| [0001](0001-supabase-plataforma-unica.md) | Supabase para BD + Auth (+ Storage) | Aceptado (almacenamiento revisado por 0007) |
...
| [0007](0007-s3-almacenamiento-evidencias.md) | Amazon S3 como almacenamiento externo de evidencias (supersede el storage de 0001) | Aceptado |
